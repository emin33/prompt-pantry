...
### Frozen variant (per 4 servings)

Combine 24 oz cream soda + ½ cup butterscotch syrup + ½ tsp salt + 1 tsp vanilla extract + ¼ tsp butter extract + ¼ tsp caramel extract. Run in an ice cream maker for 20–25 minutes until slushy, or churn 25–30 minutes in a Ninja Slushi. Top with the same foam. Frozen foam holds even longer — sip window extends to 15 min. **Blender-with-frozen-ice-cubes works in a pinch** but produces a noticeably grainier texture.

### Hot variant (per serving)

Hot Butterbeer is NOT just the cold drink heated — it's a separate dairy-based formulation. In a small saucepan over medium-low heat, whisk together 1 cup whole milk, 2 tbsp butter, 2 tbsp packed dark brown sugar, and ⅛ tsp salt until butter melts. Whisk in 2 tbsp butterscotch syrup, 2 tbsp heavy cream, and ½ tsp vanilla. Heat to 160–165°F (steaming, not bubbling). Off heat, stir in ¼ tsp butter extract. Pour into a warmed mug and top with foam (or use lightly-whipped sweetened heavy cream for the hot version — dairy Chantilly survives the heat better).
